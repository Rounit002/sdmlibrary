...
const hostelBranchesRoutes = require('./routes/hostelBranches')(pool);
const hostelStudentsRoutes = require('./routes/hostelStudents')(pool);
...
app.use('/api/hostel/branches', authenticateUser, hostelBranchesRoutes);
app.use('/api/hostel/students', authenticateUser, hostelStudentsRoutes);
